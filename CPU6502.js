...
CPU6502.prototype.set_memory_callback = function(caller, callback) {
	this.memory_caller = caller;
	this.memory_callback = callback;
}
...
CPU6502.prototype._read_memory = function(loc) {
  var soft_switch_data =  this.memory_callback.call(this.memory_caller, loc);
...
CPU6502.prototype.write_memory = function(loc, val) {
  ...
  if (this.memory_callback.call(this.memory_caller, loc, val) !== undefined) {
    return;
  }
